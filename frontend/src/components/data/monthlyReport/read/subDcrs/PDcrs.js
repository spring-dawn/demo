...
export default function PDcrs() {
    ...
    const columnDefs = [
        ...
        },
        {
            ...
            marryChildren: true,
            children: [
                { field: "location", headerName: "대지위치" },
                { field: "reportNo", headerName: "신고번호", columnGroupShow: "open" },
                { field: "owner", headerName: "소유자", columnGroupShow: "open" },
                { field: "buildUsage", headerName: "용도", columnGroupShow: "open" },
                { field: "structure", headerName: "구조", columnGroupShow: "open" },
            ],
        },
        { field: "demolitionDt", headerName: "철거예정일" },
        { field: "spaces", headerName: "면수", sortable: true },
    ...
    return (
        <div className="pageWrap">
            ...
            <Modal open={modalOpen} close={closeModal} header="주차장 감소 현황">
                <ContentModal mode={proc.mode} data={dcrs} close={closeModal} sgg={sgg} />
            </Modal>
        </div>
    );
}
